...
const Nav2 = ({ listItems }) => {
  ...
  return (
    <div className="mx-auto text-xs shadow-md px-3 w-full md:w-full ">
      <nav className="bg-white border-gray-200 w-full md:full dark:bg-gray-900 mb-2 ">
