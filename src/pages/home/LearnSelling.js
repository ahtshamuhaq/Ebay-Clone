...
import HeroSection from "../LearnToSell/HeroSection";
import { Link } from "react-router-dom";

const LearnSelling = (props) => {
  return (
    <div>
      ...
      <div className="w-[90%] mx-auto">
        ...
        <hr className="" />
        <HeroSection />
        <div className="ml-6 mb-4 mt-16 text-xs hidden sm:block">
